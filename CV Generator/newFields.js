...
div.innerHTML = '<input type="text" name="Computer Skills[Programming Languages][Language][]" pattern="[A-Za-zÀ-ÿà-ÿ]{2,20}">' +
...
var button = ev.target;
var div = document.createElement('div');
div.innerHTML = '<input type="text" name="Other Skills[Languages][Language][]" pattern="[A-Za-zÀ-ÿà-ÿ]{2,20}">' +
